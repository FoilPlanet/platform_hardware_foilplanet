...
#ifndef _FOILPLANET_OMX_VIDEO_ENCODER_H_
#define _FOILPLANET_OMX_VIDEO_ENCODER_H_
...
typedef struct _FP_OMX_VIDEOENC_COMPONENT {
...
#endif /* _FOILPLANET_OMX_VIDEO_ENCODER_H_ */

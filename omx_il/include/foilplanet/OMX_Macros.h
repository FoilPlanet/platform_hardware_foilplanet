...
#ifndef _FOILPLANET_OMX_MACROS_
#define _FOILPLANET_OMX_MACROS_
 ...
 * Port Specific
 */
#define FOILPLANET_TUNNEL_ESTABLISHED 0x0001
#define FOILPLANET_TUNNEL_IS_SUPPLIER 0x0002
...
#define CHECK_PORT_TUNNELED(port)                   (port->tunnelFlags & FOILPLANET_TUNNEL_ESTABLISHED)
#define CHECK_PORT_BUFFER_SUPPLIER(port)            (port->tunnelFlags & FOILPLANET_TUNNEL_IS_SUPPLIER)

#endif  /* _FOILPLANET_OMX_MACROS_ */
